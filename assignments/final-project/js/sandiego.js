...
let apiURLstring =
  "https://api.openweathermap.org/data/2.5/weather?lat=32.715736&lon=-117.161087&units=imperial&APPID=c56d49a01e77b339a90a3bf2c7dcf667";
...
request.onload = function() {
  ...
  for (var i = 0; i < templeclosure.length; i++) {
    ...
    if (templeclosure[i].name == "San Diego") {
